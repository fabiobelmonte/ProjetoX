...
@Named
@ViewScoped
public class MbClienteFornecedor implements Serializable {
    ...
    @Getter
    private final ClienteFornecedorAmbos[] clienteFornecedorAmbos;
    ...
    public MbClienteFornecedor() {
        ...
        clienteFornecedorAmbos = ClienteFornecedorAmbos.values();
    }
